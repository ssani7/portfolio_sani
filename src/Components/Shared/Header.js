...
const Header = ({ reference, click, nightMode, setNightMode }) => {
	...
	return (
		<div ref={reference} className={`navbar min-h-0 p-0 flex-col items-start lg:flex-row lg:items-center z-20 fixed text-content top-0`}>
			<div className={`navbar-start w-full h-full p-2 lg:px-5 lg:py-4 z-50 relative flex justify-between ${dropdown || changeBg ? 'navBg active' : 'navBg text-white'}`}>
