...
const Contact = ({ reference }) => {
    ...
    return (
        ...
        <>
            ...
            <div ref={reference} className='w-full flex justify-center items-center mt-10 mb-36' >
                    ...
                    <div className="card-body px-20">
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="form-control w-full mb-5">
                                ...
                                {errors.from_name && <span className='text-xs text-error text-center'>{errors.from_name?.message}</span>}
                            </div>
                            <div className="form-control w-full mb-5">
                                <label className="label">
                            ...
                            <div className="form-control w-full mb-5">
                                ...
                                {errors.subject && <span className='text-xs text-error text-center'>{errors.subject.message}</span>}
                            </div>
                            <div className="form-control mb-5">
                                ...
                                {errors.message && <span className='text-xs text-error text-center'>{errors.message.message}</span>}
                            </div>
